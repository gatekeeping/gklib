#include "zscript/gatekeep/game.cs"	// game singleton
#include "zscript/gatekeep/dungeon.cs" // holds template and playfield
#include "zscript/gatekeep/template.cs" // grid of zones as appearing on map
#include "zscript/gatekeep/playfield.cs" // grid of zones as placed in dungeon
#include "zscript/gatekeep/zone.cs"	// square area with a gateway on each face
#include "zscript/gatekeep/gateway.cs" // group of portals on each face of a zone
#include "zscript/gatekeep/levelinit.cs" // for manipulating level data early
#include "zscript/gatekeep/events.cs" // in-game stuff
